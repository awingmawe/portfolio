...
export const certifications = [
  {
    ...
    year: "2022",
    score: "90.9/100",
    description: "Intensive bootcamp covering modern web development stack including React, Node.js, and PostgreSQL",
    credential: "#",
    icon: "certificate",
  },
  {
    ...
    year: "2022",
    score: "88.5/100",
    description: "Specialized training in server-side development, API design, and database management",
    credential: "#",
    icon: "server",
  },
];
...
export const typewriterSequences = [
  "Frontend Engineer",
  2000,
  "React Specialist",
  2000,
